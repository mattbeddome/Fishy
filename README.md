...
In order to avoid any kind of packet sniffing that could be detected by anti-cheat measures, my method of determining what type of fish was on the line was to scan areas of the screen for pixel colours (text vs. background colour).
